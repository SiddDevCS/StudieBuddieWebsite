...
export const metadata: Metadata = {
  title: 'Privacy Policy - StudieBuddie',
  description: 'Privacy Policy for StudieBuddie application - your AI-powered study assistant.',
};
    ...
    <div className="min-h-screen">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="prose prose-lg max-w-none">
          ...
          <p>By email: <a href="mailto:siddnative@gmail.com" className="text-orange-600 hover:text-orange-800">siddnative@gmail.com</a></p>
        </div>
      </div>
    </div>
  );
